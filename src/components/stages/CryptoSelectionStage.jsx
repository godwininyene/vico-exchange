...
const CryptoSelectionStage = ({ coins, processing, onCryptoSelect, title, description }) => {
  if (processing) {
    return (
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6">
        ...
        coins.length > 0 && (
          <>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8">
              {description || "Select a cryptocurrency"}
            </p>
          </>
        )
      }
      ...
      {coins.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-gray-500 dark:text-gray-400">No cryptocurrencies available at the moment.</p>
        </div>
      ) : (
...
export default CryptoSelectionStage;