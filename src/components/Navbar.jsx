...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className={`fixed w-full bg-white shadow-md z-50 transition-all duration-300 ${isScrolled ? 'py-2' : 'py-3'}`}>
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center h-12">
            {/* Logo */}
            <Link to="/" className="flex items-center">
              <img src={logo} alt="Company Logo" className="h-8 transition-all duration-300" />
              <h1 className="font-bold ml-2 text-lg">Vico Exchange</h1>
            </Link>
