...
import VtuTransaction from "./VtuTransaction";

const VtuTransactionsList = ({transactions,openTransactionDetails, pagination, onPageChange, context})=>{
        ...
        <div className="mt-6">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
                <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white">VTU Transaction History</h2>
...
export default VtuTransactionsList